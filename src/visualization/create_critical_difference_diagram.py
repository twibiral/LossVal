...
# License: GPL3
# Source: https://github.com/hfawaz/cd-diagram
...
# matplotlib.use('agg')     # comment out because of weird side effects
...
def draw_cd_diagram(df_perf=None, alpha=0.05, title=None, labels=False, target_path='cd-diagram.pdf', width=9):
    """
    ...
    if title:
        plt.title(title,fontdict=font, y=1, x=0.5)
